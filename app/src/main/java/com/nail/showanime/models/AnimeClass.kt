...
class AnimeClass (
    ...
    companion object CREATOR : Parcelable.Creator<AnimeClass> {
        override fun createFromParcel(parcel: Parcel): AnimeClass {
            return AnimeClass(parcel)
        }

        override fun newArray(size: Int): Array<AnimeClass?> {
